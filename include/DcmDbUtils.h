...
public:
	...
	int _dcm_svc_db_get_media_uuid_by_path(const char *file_path, char **media_uuid);
	...
	int _dcm_svc_db_send_noti(int contact_id, int cluster_id, DcmFaceItemUpdateItem update_item, DcmFaceItemUpdateType update_type, char *media_id, char *uuid);
};
