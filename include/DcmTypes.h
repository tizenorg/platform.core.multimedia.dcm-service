...
#define NUM_OF_EXTRACT_COLOR_ITEM 3
...
typedef struct {
	char *media_uuid;
	char *storage_uuid;
	unsigned char rgb_r[NUM_OF_EXTRACT_COLOR_ITEM];
	unsigned char rgb_g[NUM_OF_EXTRACT_COLOR_ITEM];
	unsigned char rgb_b[NUM_OF_EXTRACT_COLOR_ITEM];
} DcmColorItem;
