...
gboolean DcmSvcAppCallBack::readMsg(GIOChannel *src, GIOCondition condition, gpointer data)
{
	DcmIpcMsg recv_msg;
	int sock = -1;
	int ret = 0;
...
gboolean DcmSvcAppCallBack::quitTimerAtMainLoop(gpointer data)
{
...
int DcmMainSvc::createQuitTimerMainLoop()
{
	...
	g_source_set_callback(quit_timer, DcmSvcAppCallBack::quitTimerAtMainLoop, (gpointer) this, NULL);
...
EXPORT_API int main(int argc, char *argv[])
{
	...
	g_source_set_callback(source, (GSourceFunc)DcmSvcAppCallBack::readMsg, NULL, NULL);
